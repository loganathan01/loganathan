package com.Adminlogin.operations;
...
import com.Adminlogin.database.Adminaction;
...
public class managementPrograss{ 
	...
	public static void main(String[] args) throws SQLException, NumberFormatException, IOException {
		...
		case 1:{
			...
			if(admin==true) {do{
				...
				case 1:System.out.print("Enter Accountant ID: ");
						...
						boolean acc=AccountLogin.accLogIn(AcccountantID);
						if(acc) {
							Adminaction.accountant(AcccountantID);
				...
				case 3:System.out.println("------------------------------------");
						...
						boolean faclog=Facultylogin.FaclogIn(LogIn);
						if(faclog) { Facultylogin.profile(LogIn);
		...
		case 2:System.out.println("====================================");
				...
				boolean con=AccountLogin.logIn(AcccountantID, Password);
				...
				if(con) {
					...
					boolean stdlogIn=AccountLogin.stdlogIn(StudentID, classs);
				if(stdlogIn) {
					System.out.println("==========================================================");  System.out.println();
					AccountActions.action(AcccountantID, Password,StudentID,classs);  System.out.println();
					System.out.println("==========================================================");
					...
					if       (op==1) {System.out.print("Please enter fees paying: ");
								...
								AccountActions.payfees(StudentID, classs, pay);}
		...
		case 3:System.out.println("====================================");
				...
				boolean fac=Facultylogin.logIn(LogIn, Facpass);
				if(fac) {
					do {
					...
					switch(fp) {
					case 1:
							Facultylogin.profile(LogIn, Facpass);
							System.out.println("------------------------------------");
							System.out.println("\t 1-> Go Back");
							System.out.println("\t 2-> Log Out");
							System.out.print("Select your option: ");
